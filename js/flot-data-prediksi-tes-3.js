...
$(document).ready(function() {
    ...
    function getHum()
    {
      ...
      var yHum = new Array();
      var yLdr = new Array();
      var url = "http://localhost/startmin-master-klasifikasi/Raspi02/api/apiGetDataJson_ldr.php";
      $.ajax({   
        type: "GET",   
        url: url,
        dataType: 'json',
  ...
  function predictHum(t, y)
  {
    ...
    document.getElementById('avgData5').innerHTML = "Mean Square Error : " +vAve/n;
    document.getElementById('avgData6').innerHTML = "Mean Absolute Percentage Error : " +(vAvea/n)*100;
