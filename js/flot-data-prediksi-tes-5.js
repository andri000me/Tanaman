...
$(document).ready(function() {
    ...
    function getHum()
    {
      ...
      var url = "http://localhost/startmin-master-klasifikasi/Raspi02/api/apiGetDataJson_ketan.php";
      $.ajax({   
        type: "GET",   
        url: url,
        dataType: 'json',
        ...
        success: function(response){           
          for(i=0;i<response.records.length;i++){
            ...
            yketan[i] = parseFloat(response.records[i].ketan);
  ...
  function predictHum(t, y)
  {
    ...
    document.getElementById('avgData9').innerHTML = "Mean Square Error : " +vAve/n;
    document.getElementById('avgData10').innerHTML = "Mean Absolute Percentage Error : " +(vAvea/n)*100;
