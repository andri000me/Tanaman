...
$(document).ready(function() {
    ...
    function getHum()
    {
      ...
      var yHum = new Array();
      var yTemp = new Array();
      var url = "http://localhost/startmin-master-klasifikasi/Raspi02/api/apiGetDataJson_temp.php";
      $.ajax({   
        type: "GET",   
        url: url,
        dataType: 'json',
  ...
  function predictHum(t, y)
  {
    ...
    for(var i = 0; i < 83; i++) {
      ...
      // {
        ...
        console.log('st1 = ' +st1[lastT])
        console.log('st2 = ' +st2[lastT])
        console.log('st3 = ' +st3[lastT])

        console.log('at = ' +at[lastT])
        console.log('bt = ' +bt[lastT])
        console.log('ct = ' +ct[lastT])
        console.log('ft = ' +ft[lastT])
        console.log('ny = ' +ny)
    ...
    document.getElementById('avgData1').innerHTML = "Mean Square Error : " +vAve/n;
    document.getElementById('avgData2').innerHTML = "Mean Absolute Percentage Error : " +(vAvea/n)*100;
