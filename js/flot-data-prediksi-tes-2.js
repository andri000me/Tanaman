...
$(document).ready(function() {
    ...
    function getHum()
    {
      ...
      var yHum = new Array();
      var yTemp = new Array();
      var url = "http://localhost/startmin-master-klasifikasi/Raspi02/api/apiGetDataJson_hum.php";
      $.ajax({   
        type: "GET",   
        url: url,
        dataType: 'json',
  ...
  function predictHum(t, y)
  {
    ...
    document.getElementById('avgData3').innerHTML = "Mean Square Error : " +vAve/n;
    document.getElementById('avgData4').innerHTML = "Mean Absolute Percentage Error : " +(vAvea/n)*100;
